...
//                    val savedRouteAssociation = SavedUserRouteEntity(it.value.first,savedRoute)
                ...
                database.getReference("savedRouteAssociations").updateChildren(savedRoutesMap as Map<String, Long>)
...
//                    val savedRouteAssociation = SavedUserRouteEntity(it.value.first,savedRoute)
                ...
                database.getReference("savedSightAssociations").updateChildren(savedSightsMap as Map<String, Long>)
...
//                    val savedRouteAssociation = SavedUserRouteEntity(it.value.first,savedRoute)
                ...
                database.getReference("completedRouteAssociations").updateChildren(completedRoutesMap as Map<String, Long>)
...
//                    val savedRouteAssociation = SavedUserRouteEntity(it.value.first,savedRoute)
                ...
                database.getReference("completedSightAssociations").updateChildren(completedSightsMap as Map<String, Long>)
            }
        }
